...
@Component
public class DraftHandler implements ProcessHandler {
    @Override
    public ProcessNodeEnum getNode() {
        return ProcessNodeEnum.DRAFT_NODE;
    }
    ...
    public void handle(ProcessContext context) {
        context.setNextState(ProcessStateEnum.DRAFT);
        context.setOperateType("保存草稿");
    }
}