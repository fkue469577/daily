...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
     ...
     */
    private static void isTrue(final String name, final boolean condition) {
        if (!condition) {
    ...
    private static <T> T convertToType(final Class<T> clazz, final Object value, final String errorMessage) {
