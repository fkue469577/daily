(function () {
        ...
        getAllPic: function (sel, $w, editor) {
            ...
            $.each($imgs, function (index, node) {
               ...
               //  });
                ...
                var imgsrc = node.src.replace(window.location.origin, '');
                return arr.push({
                    _src: imgsrc,
                    src: imgsrc
                });
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"display: none\" type="text" name="courseId" class="editorImages_courseId"/>' +
            '<input style=\"display: none\" type="text" name="chapterId" class="editorImages_chapterId"/>' +
            '</form>' +
